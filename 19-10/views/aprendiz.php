...
print("
  ...
  <div class='container-fluid'>
    <a class='navbar-brand' href='#'>APRENDIZ</a>
    ...
    <br>
    <br>
    <form action='../views/alumno/addAlumno.php' method='POST'>
...
<script type="text/javascript">
  function validar(id){
    var dato = confirm("¿Seguro que desea actualizar al aprendiz? " + id);
  if(!dato){
  ...
  function borrar(id){
    var dato = confirm("¿Seguro que desea borrar al aprendiz? " + id);
  if(!dato){
    window.location.href="../views/aprendiz.php";
  }else{
